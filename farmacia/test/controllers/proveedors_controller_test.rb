...
class ProveedorsControllerTest < ActionController::TestCase
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post :create, proveedor: { direccion: @proveedor.direccion, email: @proveedor.email, prov_active: @proveedor.prov_active, razon_social: @proveedor.razon_social, ruc: @proveedor.ruc, telefono: @proveedor.telefono }
    end
  ...
  test "should update proveedor" do
    patch :update, id: @proveedor, proveedor: { direccion: @proveedor.direccion, email: @proveedor.email, prov_active: @proveedor.prov_active, razon_social: @proveedor.razon_social, ruc: @proveedor.ruc, telefono: @proveedor.telefono }
    assert_redirected_to proveedor_path(assigns(:proveedor))
  end
